...
// CPU frequency
//
// setCpuFrequencyMhz() stays a stub: with CONFIG_PM_ENABLE off the frequency is
// fixed at boot by CONFIG_ESP_DEFAULT_CPU_FREQ_MHZ (sdkconfig.defaults), and there
// is no runtime scaling to hook. The getter is real, and is logged at boot —
// the ESP-IDF migration silently dropped the clock from 240MHz to the vanilla
// 160MHz default for months precisely because nothing ever printed it.
// ============================================================================
